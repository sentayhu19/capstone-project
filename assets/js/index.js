...
hamburger.addEventListener("click", () => {
  document.getElementById("cover").style.cssText =
    "display: block; position: fixed; z-index: 5; width: 100%; height: 100%; background-color: #272a31; opacity: 0.9; top:0; left:0; mix-blend-mode: multiply; backdrop-filter: blur(6px);";
